function ManageViewModel(app, dataModel) {
            ...
            dataModel.getManageInfo(dataModel.returnUrl, true /* generateState */)
                .done(function (data) {
                    if (typeof (data.localLoginProvider) !== "undefined" &&
                        ...
                        app.errors.push("Erreur lors de la récupération des informations d’utilisateur.");
                    }
    ...
    self.addExternalLogin = function (externalAccessToken, externalError) {
        if (externalError !== null || externalAccessToken === null) {
            self.errors.push("Impossible d’associer le nom de connexion externe.");
            self.load();
        } else {
            dataModel.addExternalLogin({
                ...
                if (errors) {
                    ...
                    self.errors.push("Une erreur inconnue s’est produite.");
                }
...
function ChangePasswordViewModel(app, parent, name, dataModel) {
    ...
    self.change = function () {
        ...
        dataModel.changePassword({
            ...
            self.changing(false);
            reset();
            parent.message("Votre mot de passe a été modifié.");
        }).failJSON(function (data) {
            var errors;
...
function RemoveLoginViewModel(data, parent, dataModel) {
    ...
    self.remove = function () {
        ...
        dataModel.removeLogin({
            ...
            parent.message("Le nom de connexion a été supprimé.");
        }).failJSON(function (data) {
            var errors;
            ...
            if (errors) {
                ...
                parent.errors.push("Une erreur inconnue s’est produite.");
            }
        });
    };
}
...
function SetPasswordViewModel(app, parent, dataModel) {
    ...
    self.set = function () {
        ...
        dataModel.setPassword({
            ...
            parent.message("Votre mot de passe a été défini.");
        }).failJSON(function (data) {
            var errors;
